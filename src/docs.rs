...
use crate::models::{
    ...
    EventCustomItemPayload, EventItemAttachPayload, EventItemCategorySummary,
    EventItemReservationPayload, EventItemView, EventPatchPayload, EventPayload,
    EventPollCreatePayload, EventPollVotePayload, Friend, FriendRequest,
...
#[openapi(
    paths(
        ...
        crate::routes::events::list_event_item_summary,
